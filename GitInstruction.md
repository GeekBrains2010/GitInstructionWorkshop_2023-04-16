...
В современном мире основная система контроля версий - это Git, но так же есть и Mercury.
Кроме того, есть устаревшие системы контроля версий, такие как CVS, SVN, TFS и Subversion.
