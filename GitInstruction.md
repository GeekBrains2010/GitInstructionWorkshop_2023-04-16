...
### Что такое система контроля версий? - программное обеспечение, которое обеспечивает командную работу в рамках одного или нескольких проектов. 

### Для чего нужна система контроля версий - для отслеживания изменений исходного кода с течением времени
