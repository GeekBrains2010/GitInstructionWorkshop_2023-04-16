...
В современно м мире основная системя контроля версий это git, но также есть и Mercury, кроме того есть устаревшие системы контроля версий такие как: СVS,SVN,TFS, И Subversion
