...
Необходима для сохранения изменений версий файлов, создавать новые записи и файлы, переходить по различным веткам (работа в группе), возвращаться к старым версиям
