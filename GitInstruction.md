...
В современном мире основная система контроля версий это git, но также есть и Mercury, кроме того есть устаревшие состемы контроля версий, такие как CVS, SVN, TFS и Subversion
