# Инструкция по работе с git # Инструкция по работе с git# Инструкция по работе с git# Инструкция по работе с git# Инструкция по работе с git
Git — мощная и сложная распределенная система контроля версий.
sfsdgfdsgdgsdgsdgsdgsd
