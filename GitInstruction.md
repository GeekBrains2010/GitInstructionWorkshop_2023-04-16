...
Основной веткой по умолчанию в локальном репозитории является __master__. Чтобы создать новую ветку в локальном репозитории наберите команду _**git branch new_branch**_, где *new_branch* - это название ветки.
