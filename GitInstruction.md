...
# Использование HTML тегов в Markdown 

В Markdown можно использовать элементы HTML для форматирования текста. 

В Markdown можно использовать HTML теги для изменения цвета текста. Для этого нужно использовать тег `<font>` со свойством `color` и указать нужный цвет в кавычках. Пример:
```html
Этот текст будет <font color="red">красным</font>, а этот - <font color="blue">синим</font>.
```
Вот так это будет выглядеть:

Этот текст будет <font color="red">красным</font>, а этот - <font color="blue">синим</font>.

Также можно использовать специальные символы для изменения цвета текста в Markdown. Например:

```html
Этот текст будет **<span style="color: red">красным</span>**, а этот - **<span style="color: blue">синим</span>**.
```
Этот текст будет **<span style="color: red">красным</span>**, а этот - **<span style="color: blue">синим</span>**.
