...
**git branch -- all** - показывает ветки на удаленном репозитории

**git log --oneline** - сокращенно показывает коммиты

**git checkout b848** - переход к коммиту hash b848

**git --oneline --all** - если гит не хочет показывать коммиты

**git log --oneline --all --graph** - отображает комиты с ветками

**git log -p** - покажет всё
