...
В современном мире основная система контроля версий это git, кроме того есть Mercury, так же есть устаревшие системы контроля версия, такие как CVS, SVN, TFS и Subversion.
