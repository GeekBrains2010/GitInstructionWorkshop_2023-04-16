...
Для того, чтобы создать локальный репозиторий, необходимо указать Git адрес куда будет отправлен локальный репозиторий и зарегистрироваться в Git при первом использовании.
