...
В современном мире основная система контроля версий это git, но также есть и mercury, кроме того есть устаревшие системы контроля версий, такие как CVS, SVN, TFS и Subversion.
